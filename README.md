...
- **[job-search-tool](https://github.com/yanucodes/job-search-tool)** — Job-search tracker: applications, recruiter contacts, fairs and networking, each moving through its own timeline, exported as a German PDF summary for the Arbeitsagentur. `Flask` · `Jinja2`
