...
- **[job-search-tool](https://github.com/yanucodes/job-search-tool)** — Job-search tracker: applications, recruiter contacts, fairs and networking, each moving through its own timeline, exported as a German PDF summary for the Arbeitsagentur. `Flask` · `Jinja2` · `LaTeX`
...
[data reduction package](https://github.com/yanucodes/obs_sofi)
for the SOFI camera using the LSST (now Vera Rubin Observatory) software stack. Throughout my PhD and PostDoc, I have written numerous Python scripts and notebooks for data analysis, visualisation and image processing.
