...
- **[job-search-tool](https://github.com/yanucodes/job-search-tool)** — Job-application tracker that surfaces each new posting once, moves it through a pipeline, and exports the history to PDF. Pluggable job boards (Arbeitsagentur API). `Flask` · `Jinja2`
